...
bullety = 480
bulletx_change = 0
bullety_change = 10 * enemy_speed_x
bullet_state = "ready"
...
while running:
    ...
    if not itsover:
        for i in range(number_of_enemies):
            ...
            if enemyx[i] <= 0:
                enemyx_change[i] = 1.0 * enemy_speed_x
            ...
            if enemy_bullet_state[i] == "ready" and random.randint(1, 500) == 1:
                values_random = [-1, 0, 1]
    ...
    clock.tick(800)  # Limitar el framerate a 60 FPS
